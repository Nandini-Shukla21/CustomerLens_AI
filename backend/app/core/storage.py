...
def initialize_database() -> None:
    with connection() as conn:
        conn.executescript("""
        CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY, email TEXT UNIQUE NOT NULL, password_hash TEXT NOT NULL, role TEXT NOT NULL DEFAULT 'Viewer', created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP);
        ...
        CREATE TABLE IF NOT EXISTS documents (id TEXT PRIMARY KEY, filename TEXT NOT NULL, path TEXT NOT NULL, content TEXT NOT NULL, chunks_json TEXT NOT NULL, owner_id INTEGER, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY(owner_id) REFERENCES users(id));
        ...
        CREATE TABLE IF NOT EXISTS uploads (id TEXT PRIMARY KEY, dataset_id TEXT, document_id TEXT, filename TEXT NOT NULL, status TEXT NOT NULL, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP);
        """)
